...
work_dir = '/home/ubuntu/mytrain/fcn_vgg_cityscapes/'
...
transform = dict(
        img_params=dict(
                ...
                size_divisor=None,
                keep_ratio=False),  # ssd需要统一到方形，不能按比例
        label_params=None,
        bbox_params=None,
        aug_params=None,
        seg_params=dict(
...
data_root_path='/media/ubuntu/4430C54630C53FA2/SuLiang/MyDatasets/cityscapes/'
trainset = dict(
        type='cityscapes',
        repeat=0,
        params=dict(
...
valset = dict(
        ...
        params=dict(
                root_path=data_root_path, 
                ann_file=[data_root_path + 'valInstances.txt'], 
                img_prefix=[data_root_path],
                mode='val'))                 
