...
work_dir = '/home/ubuntu/mytrain/ssd_vgg_coco/'
...
data_root_path='/home/ubuntu/MyDatasets/coco/'
trainset = dict(
        type='coco',
        repeat=0,
        params=dict(
                root_path=data_root_path, 
                ann_file=[data_root_path + 'annotations/instances_train2017.json'], #分为train.txt, val.txt, trainval.txt, test.txt
                img_prefix=[data_root_path + 'train2017/'],
                mode='train'))    # mode用来评估是否过滤图片
...
valset = dict(
        ...
        params=dict(
                root_path=data_root_path, 
                ann_file=[data_root_path + 'annotations/instances_val2017.json'], #分为train.txt, val.txt, trainval.txt, test.txt
                img_prefix=[data_root_path + 'val2017/'],
                mode='val'))
