...
class Bottleneck(nn.Module):
    ...
    def __init__(self, in_channels, out_channels, stride, with_downsample=False):
        ...
        self.bn1 = nn.BatchNorm2d(out_channels)
        self.conv2 = nn.Conv2d(out_channels, out_channels, kernel_size=3, stride=stride, bias=False)  # 该层用于downsample，需要跟identity分支的downsample一致的stride
        self.bn2 = nn.BatchNorm2d(out_channels)
...
class Resnet(nn.Module):
    ...
    1. 如果是basicblock, 
       ...
       而如果bottleneck:
        ...
        64-64-256       256-128-512     512-256-1024    1024-512-2048
        256-64-256      512-128-512     1024-256-1024   2048-512-2048
        256-64-256      512-128-512     1024-256-1024   2048-512-2048
                        512-128-512     1024-256-1024
                                        1024-256-1024
                                        1024-256-1024
