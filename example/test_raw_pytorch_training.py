...
# -*- coding: utf-8 -*-
"""
Created on Wed Sep  4 15:48:15 2019
...
trainset = torchvision.datasets.CIFAR10(root='../dataset/source/', train=True,
                                        download=False, transform=transform)
img, label = trainset[0]
trainloader = torch.utils.data.DataLoader(trainset, batch_size=4,
                                          shuffle=True, num_workers=2)

testset = torchvision.datasets.CIFAR10(root='../dataset/source/', train=False,
...
images, labels = dataiter.next()  # 得到的是(4, 3, 32, 32), (4)
