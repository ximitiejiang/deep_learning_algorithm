...
"""SSD anchor:  anchor_base = [30, 60, 111, 162, 213, 264]
                anchor_scales = [[1.0, 1.414], [1.0, 1.36], [1.0, 1.2], [1.0, 1.146], [1.0, 1.113], [1.0, 1.09]]
                anchor_ratios = [1.0, 1/2, 2, 1/3, 3]
                
                anchors_per_cell = [4, 6, 6, 6, 4, 4]
                stride = [8, 16, 32, 64, 128]
                featmap size = [38*38, 19*19, 10*10, 5*5, 3*3, 1*1]
                
                说明：最小anchor为30*1*1=30
"""

"""retinanet anchor: anchor_base = [8,16,32,64,128], 
                     anchor_scales = [4., 5., 6.35], 
                     ...
                     说明：最小anchor为8*4*1 = 32
                     32*32, 40*40, 50*50), (64*64, 80*80, 101*101), (128*128, 160*160, 203*203), (256*256, 320*320, 406*406), (512*512, 640*640, 812*812) 
"""
